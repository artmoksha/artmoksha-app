  ...
  return (
    <>
      <section className="text-gray-600 body-font relative">
        ...
        <div className="container px-5 pt-12 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
          <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
            <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
              ...
              <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
                ...
                <a href="javascript:void(0)" className="text-indigo-500 leading-relaxed mt-4 block">
                  example@email.com
                </a>
          ...
          <div className="lg:w-1/3 md:w-1/2 flex flex-col md:ml-auto w-full md:mt-0">
            <div className="bg-white dark:bg-gray-800 p-8 rounded shadow">
              <h2 className="text-gray-900 text-lg mb-1 font-medium title-font dark:text-gray-100">
                Feedback
              </h2>
              <p className="leading-relaxed mb-5 text-gray-600 dark:text-gray-100">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit excepturi explicabo iure
                maxime
              </p>
